...
flags.DEFINE_string('fid_cache', './stats/cifar10.test.npz', help='FID cache')
...
def train():
    ...
    # log setup - create the sample_Unet directory instead of sample
    os.makedirs(os.path.join(FLAGS.logdir, 'sample_Unet'), exist_ok=True)
        ...
        for step in pbar:
            ...
            if FLAGS.sample_step > 0 and step % FLAGS.sample_step == 0:
                ...
                with torch.no_grad():
                    ...
                    path = os.path.join(
                        FLAGS.logdir, 'sample_Unet', '%d.png' % step)
